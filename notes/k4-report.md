...
- **F13 External plaintext claims are quarantined before verification (H3)**
  ...
  - Next test: Do not promote the claim from length/anchor, table-shape compatibility, archive-discovery reporting, or the canonical-bundle reconciliation check. Any follow-up must implement an independent mechanical verifier for the claimed physical helper stream or obtain independent non-anchor evidence before adding source-derived hypothesis or candidate material.
  - Promoted: false
