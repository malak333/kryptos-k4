...
- `prlog-bishop-k4-claim-2020` [Stephen Bishop PRLog Kryptos K4 claim](https://www.prlog.org/12839961-solving-kryptos-vigenere-cipher-final-k4-section-finally-solved.pdf) - Public claimed K4 plaintext from a self-published PRLog PDF; quarantined for future independent verification only, not source-backed evidence, not candidate material, and not release-facing plaintext.; type: community-solution-claim; accessed 2026-05-31; use: unverified-solution-claim
