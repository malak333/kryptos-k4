...
- **F11 CIA row-boundary observation is source-backed but negative (H3)**
  ...
  - Interpretation: The row-boundary observation is auditable independent evidence, but it is negative for the committed period, spacing, mirror, grid-row, grid-column, grid-compass-axis, grid-width-7-row, Tableau/HILL, and ciphertext-only targets and promotes no K4 candidate.
