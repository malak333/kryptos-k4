...
| `validate-period-observations` | Gate for source-backed independent position observations before period prediction scoring. |
...
| `evaluate-period-prediction` | Independent-position evaluator for committed period prediction artifacts with best-of-period null controls and source-backed observation-file input. |
