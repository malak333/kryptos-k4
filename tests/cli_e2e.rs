...
fn source_frontier_classifies_all_registered_sources() {
    Command::cargo_bin("kryptos-k4")
        ...
        .stdout(predicate::str::contains("valid source-backed archives: 33"))
        .stdout(predicate::str::contains(
            "all source-backed archives negative: false",
        ))
        .stdout(predicate::str::contains(
        ...
        .stdout(predicate::str::contains(
            "Already used in 33 source-backed evaluation archives",
        ))
    ...
    assert_eq!(cia_sculpture["source_backed_archive_count"], 33);
    assert!(
...
fn source_frontier_summary_prints_compact_next_action() {
    ...
    assert!(
        json["already_scored_source_backed_archives"][0]
            .as_str()
            .unwrap()
            .contains("cia-sculpture (33 archived evaluations)")
    );
    assert!(
        json["action"]
            .as_str()
...
fn independent_lane_status_summarizes_ready_lanes() {
    Command::cargo_bin("kryptos-k4")
        ...
        .stdout(predicate::str::contains(
            "| ciphertext-adjacent-contrast-position-prior | 2 | 2 | 2 | 2 | 2 | 0 |",
        ))
        .stdout(predicate::str::contains(
    ...
    assert!(gates.iter().any(|gate| {
        gate["hypothesis_family"] == "ciphertext-adjacent-contrast-position-prior"
            && gate["representative_preregistration"]
                == "experiments/preregistrations/ciphertext-adjacent-contrast-narrow-v1.json"
            && gate["ready_lanes"] == 2
            && gate["unique_ready_prediction_artifacts"] == 2
            ...
            && gate["validation_command"]
                .as_str()
                .unwrap()
                .contains("experiments/predictions/ciphertext-adjacent-contrast-narrow-v1.json")
