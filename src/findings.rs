...
pub fn findings() -> Vec<Finding> {
    vec![
        ...
        Finding {
            ...
            transformation_steps: &[
                "validate the v2, v3, and v4 preregistrations with JSON output",
                "validate the committed v2, v3, and v4 prediction artifacts with JSON output",
                "run release-check in JSON mode and require every local preflight gate to pass",
            ],
            output_summary: "The v2, v3, and v4 preregistrations and artifacts validate as non-promotional, and release-check JSON reports every local gate as passed.",
