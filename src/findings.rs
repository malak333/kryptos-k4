    ...
    vec![
        ...
        Finding {
            ...
            source_inputs: &[
                ...
                "experiments/preregistrations/ciphertext-adjacent-contrast-narrow-v1.json",
                "experiments/predictions/ciphertext-adjacent-contrast-narrow-v1.json",
                ...
                "experiments/preregistrations/ciphertext-residue-balance-hyper-extreme-moduli-v1.json",
                "experiments/predictions/ciphertext-residue-balance-hyper-extreme-moduli-v1.json",
                "experiments/preregistrations/ciphertext-residue-balance-terminal-moduli-v1.json",
                ...
                "experiments/predictions/non-anchor-position-grid-4x25-row-v1.json",
        ...
        Finding {
            ...
            source_inputs: &[
                ...
                "experiments/predictions/ciphertext-window-balance-mid-v1.json",
                ...
                "experiments/preregistrations/ciphertext-window-balance-mega-wide-v1.json",
                "experiments/predictions/ciphertext-window-balance-mega-wide-v1.json",
        ...
        Finding {
            ...
            source_inputs: &[
                ...
                "experiments/preregistrations/non-anchor-position-grid-width7-row-v1.json",
                "experiments/predictions/non-anchor-position-grid-width7-row-v1.json",
                "results/grid-observations/cia-k4-row-boundaries-width7-row-v1",
                "experiments/preregistrations/non-anchor-position-grid-4x25-row-v1.json",
                "experiments/predictions/non-anchor-position-grid-4x25-row-v1.json",
                "results/grid-observations/cia-k4-row-boundaries-4x25-row-v1",
                "experiments/preregistrations/tableau-hill-v1.json",
                "experiments/predictions/tableau-hill-v1.json",
                "experiments/preregistrations/ciphertext-hotspot-prior-v1.json",
                "experiments/predictions/ciphertext-hotspot-prior-v1.json",
                ...
                "experiments/preregistrations/ciphertext-period-match-extended-v1.json",
                "experiments/predictions/ciphertext-period-match-extended-v1.json",
                "results/ciphertext-period-match-observations/cia-k4-row-boundaries-extended-v1",
                "experiments/preregistrations/ciphertext-adjacent-contrast-prior-v1.json",
                "experiments/predictions/ciphertext-adjacent-contrast-prior-v1.json",
                "experiments/preregistrations/ciphertext-transition-prior-v1.json",
                "experiments/predictions/ciphertext-transition-prior-v1.json",
                ...
                "experiments/preregistrations/ciphertext-stehle-regularity-v1.json",
                "experiments/predictions/ciphertext-stehle-regularity-v1.json",
                "results/ciphertext-stehle-regularity-observations/cia-k4-row-boundaries-v1",
                "experiments/preregistrations/ciphertext-residue-balance-high-moduli-v1.json",
                "experiments/predictions/ciphertext-residue-balance-high-moduli-v1.json",
                "experiments/preregistrations/ciphertext-residue-balance-very-high-moduli-v1.json",
                "experiments/predictions/ciphertext-residue-balance-very-high-moduli-v1.json",
                ...
                "experiments/preregistrations/ciphertext-residue-balance-super-extreme-moduli-v1.json",
                "experiments/predictions/ciphertext-residue-balance-super-extreme-moduli-v1.json",
                "results/ciphertext-residue-balance-observations/cia-k4-row-boundaries-super-extreme-moduli-v1",
            ],
            transformation_steps: &[
        ...
        Finding {
            ...
            transformation_steps: &[
                ...
                "verify local plaintext plus running-key-stream files with length, public-anchor, and additive ciphertext reconstruction checks only",
                ...
                "register the SSRN running-key claim as an unverified solution-claim source and require local plaintext/key-stream files for any reconstruction check",
                ...
                "screen the public SolveKryptos canonical mechanism files from /private/tmp with f/helper-card, control-card, Z2 handoff, Y-pass gate-template, and Z2 helper-path grid checks",
                "compare the Y-template declared zero-position list against the zero positions implied by its printed rule and Y row",
