...
pub fn findings() -> Vec<Finding> {
    vec![
        ...
        Finding {
            ...
            transformation_steps: &[
                "validate the follow-up, v2, v3, v4, and v5 preregistrations with JSON output",
                "validate the committed follow-up, v2, v3, v4, and v5 prediction artifacts with JSON output",
                "run release-check in JSON mode and require every local preflight gate to pass",
            ],
            output_summary: "The follow-up, v2, v3, v4, and v5 preregistrations and artifacts validate as non-promotional, and release-check JSON reports every local gate as passed.",
