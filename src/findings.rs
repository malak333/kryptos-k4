    ...
    vec![
        ...
        Finding {
            ...
            transformation_steps: &[
                ...
                "validate the retained positions against period, spacing, mirror, grid row, grid column, grid compass-axis, Tableau/HILL, and ciphertext-only preregistrations including window-balance, period-match, high-moduli, and very-high-moduli residue balance",
