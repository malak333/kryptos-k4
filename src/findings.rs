...
pub fn findings() -> Vec<Finding> {
    vec![
        ...
        Finding {
            ...
            output_summary: "The lane-status command reports 17 lanes, 17 ready for source-backed observations, 0 invalid lanes, 17 prediction artifacts, 2 unique prediction artifact contents, 2 unique ready prediction artifact contents, 1 duplicate artifact group, period family 16 lanes/1 unique ready artifact, spacing family 1 lane/1 unique ready artifact, and promoted false.",
