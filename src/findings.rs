    ...
    vec![
        ...
        Finding {
            ...
            transformation_steps: &[
                ...
                "validate the retained positions against period, spacing, mirror, grid row, grid column, grid compass-axis, Tableau/HILL, and ciphertext-only preregistrations including period-match, high-moduli, and very-high-moduli residue balance",
        ...
        Finding {
            ...
            transformation_steps: &[
                ...
                "verify local claim reconciliation tables with row, ciphertext, public-anchor, and aggregate shift diagnostics only",
