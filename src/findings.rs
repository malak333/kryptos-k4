    ...
    vec![
        ...
        Finding {
            ...
            transformation_steps: &[
                ...
                "verify local claim reconciliation tables with row, ciphertext, optional coordinate and shift/gate arithmetic, public-anchor, and aggregate shift diagnostics only",
