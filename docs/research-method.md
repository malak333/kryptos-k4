...
optional published `Tier`/`Lane`, `C#`/`P#`, `R`/shift, `BaseR`, and `Gate`
arithmetic, and aggregate shift diagnostics; they do not print or store claimed
plaintext and cannot promote a candidate.
