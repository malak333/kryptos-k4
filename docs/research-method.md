...
- grid-layout-prediction-plan emits a predeclared padded grid-layout artifact from source-context layout rationale, with explicit dimensions and a scored row, column, or compass edge axis, without scoring public fragment values or candidate material;
