...
- proposed key-material checks and cyclic offset sweeps against public span-derived additive fragments at actual K4 positions;
...
- test-key output compares proposed material against public spans in Markdown/JSON, ranks cyclic phase offsets when requested, and rejects material that cannot produce numeric values;
