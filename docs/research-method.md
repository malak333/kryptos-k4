...
The `release-check` command verifies the no-Actions/no-Dependabot policy, required release docs, generated Markdown report presence, source-packet/source-registry field alignment, and absence of explicit leaked/full-plaintext sentinel markers before release.
