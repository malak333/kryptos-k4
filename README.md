...
| `ciphertext-stehle-regularity-prior` | Emits the source-grounded Stehle local-regularity planning artifact, recording the source-reported 55 through 63 anomaly label and repo canonical 56 through 64 coordinate mapping. It is evaluator-pending and must not be scored until a family-specific evaluator and null controls exist. |
