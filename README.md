...
passes. Add `--output-dir` to archive the scored `observations.json`,
`result.json`, `summary.md`, and `command.txt` for source-backed observation
runs under the ignored `results/` tree.
