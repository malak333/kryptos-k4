...
| `release-check` | Local release preflight confirming no hosted automation, required docs, generated report presence, source-packet/source-registry field alignment, and plaintext-leakage sentinel absence. |
