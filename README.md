...
| `independent-lane-status` | Operational summary of preregistered independent lanes, artifact validity, readiness for source-backed observations, unique ready prediction artifacts, duplicate artifact groups, and next required validator/evaluator command. |
