...
- Proposed key-material checks, explanations, descriptive match-pattern metrics, and composite pattern-score controls against public span-derived additive fragments.
