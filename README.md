...
cargo run -- validate-period-observations --artifact experiments/predictions/non-anchor-position-period-v1.json --input <source-backed-observations.json>
...
| `validate-period-observations` | Gate for source-backed independent position observations; rejects unregistered source IDs, duplicates, and public-anchor positions before scoring. |
