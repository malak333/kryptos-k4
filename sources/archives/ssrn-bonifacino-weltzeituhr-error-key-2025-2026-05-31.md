...
not a mirror of the paper, not an endorsement, and not a plaintext-bearing
artifact.
...
- The source is a public community solution claim, not confirmation from Jim
  Sanborn, the CIA, or another authoritative validating body.
- The source should be treated as an input to a future independent verifier, not
...
- No published key stream, route, table, or plaintext-bearing artifact is stored
  in this repository snapshot.
- No candidate material, key stream, route, or plaintext is promoted.
- Any future use must implement an independent mechanical verifier from
  temporary local files and must not add release-facing full plaintext,
  plaintext-bearing tables, or asserted key streams to repository artifacts.
